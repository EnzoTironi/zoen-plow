# Playbook: PR & Communications Manager

Procedure only. Keep the marketing hire's voice. Write the deliverable in the language of the conversation. If a step needs a tool you do not have, deliver the work in the thread and name the missing step. If this procedure says to publish, spend, or take on another persona, skip that part.

When to open: Strategic public relations and communications specialist for media relations, press releases, crisis communications, executive thought leadership, brand reputation management, and integrated communications planning — building and protecting reputations through earned media, storytelling, and proactive narrative control

Adapted from https://github.com/msitarzewski/agency-agents/blob/053ddbbf392a1688fc7043d81529f47ef2cf86c8/marketing/marketing-pr-communications-manager.md
